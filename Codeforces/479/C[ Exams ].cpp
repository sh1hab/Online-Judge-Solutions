head>
    ...
    <meta name="X-Csrf-Token" content="178d76e803b8503c32fba75574a04d34"/>
    ...
    <meta property="og:title" content="Submission #15513105 - Codeforces"/>
    ...
    <title>Submission #15513105 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='178d76e803b8503c32fba75574a04d34'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F479%2Fsubmission%2F15513105">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='178d76e803b8503c32fba75574a04d34'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    <td>
        <a title="C - Exams" href="/contest/479/problem/C">479C</a>
    ...
    <td>2016-01-23 14:22:32</td>
    <td>2016-01-23 14:22:33</td>
    <td>
...
//int a[ 101 ];
//int ite[ 5 ];
pair<long long,long long>pair1[5001];
//map<ll,ll>map1;
...
int main()
{
    ...
    while( scanf("%I64d",&n)==1 )
    {
        for(i=0; i<n; i++)
        {
            scanf("%I64d %I64d",&pair1[i].first,&pair1[i].second);
        }
        sort( pair1,pair1+n );
        long long last;
        for( i=0; i<n; i++ )
