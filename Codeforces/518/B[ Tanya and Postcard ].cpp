head>
    ...
    <meta name="X-Csrf-Token" content="0190c2f93517292766beda25649335d9"/>
    ...
    <meta property="og:title" content="Submission #10024881 - Codeforces"/>
    ...
    <meta name="cc" content="1e13c8321d44f8193e4abe8e8f1bf1f4f4a0b18b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #10024881 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0190c2f93517292766beda25649335d9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F518%2Fsubmission%2F10024881">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0190c2f93517292766beda25649335d9'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    <td>
        <a title="B - Tanya and Postcard" href="/contest/518/problem/B">518B</a>
...
//cout<<map1[x]<<&#39; &#39;<<map2[x]<<endl;
            ...
            if( map1[ x ] && map2[ x + 32 ]   )
            {
                WHOOPS+=min( map2[ x + 32 ],map1[ x ] );
            }
            //cout<<map2[x+32]<<&#39; &#39;<<x<<endl;
            else if( map2[ x - 32 ] && map1[ x ] )//upper case
            {
                WHOOPS+=min( map2[ x - 32 ],map1[ x ] );
                //cout<<map2[x-32]<<&#39; &#39;<<x<<endl;
            }
