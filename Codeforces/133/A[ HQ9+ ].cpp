head>
    ...
    <meta name="X-Csrf-Token" content="762c95dff0344195f99c24ccd11814b8"/>
    ...
    <meta property="og:title" content="Submission #11598981 - Codeforces"/>
    ...
    <title>Submission #11598981 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='762c95dff0344195f99c24ccd11814b8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F133%2Fsubmission%2F11598981">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='762c95dff0344195f99c24ccd11814b8'/>
...
int main()
{
    ...
    while( cin>>input1 )
    {
        ...
        for( i=0; i<n ; i++ )
        {
            if(  input1[i]==&#39;Q&#39; || input1[i]==&#39;H&#39; || input1[i]==&#39;9&#39; )
            {
                sum=1;
                break;
            }
