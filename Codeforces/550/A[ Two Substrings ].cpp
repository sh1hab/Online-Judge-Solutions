head>
    ...
    <meta name="X-Csrf-Token" content="886620f31ca03b3298cf54eca8db1fbf"/>
    ...
    <meta property="og:title" content="Submission #13208657 - Codeforces"/>
    ...
    <meta name="cc" content="36a12f78dab39aacb1d933aadb0ebfd0fa4a507b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #13208657 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='886620f31ca03b3298cf54eca8db1fbf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F550%2Fsubmission%2F13208657">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='886620f31ca03b3298cf54eca8db1fbf'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    ...
    <td>2015-09-24 21:02:57</td>
    <td>2015-09-24 21:02:58</td>
    <td>
...
int main()
{
    ...
    while( cin>>input )
    {
        ...
        for( ;input[i]!=&#39;\0&#39;;i++ )
        {
            if( (input[i]==&#39;B&#39; && input[i+1]==&#39;A&#39;) || (input[i]==&#39;A&#39; && input[i+1]==&#39;B&#39;) )
            {
                ba=1;
                break;
            }
...
//if(  )
        ...
        //else
        {
            ...
            l=input.find( "BA" );
            //cout<<i<<&#39; &#39;<<l<<endl;
            if( i<input.length() && l<input.length() )
            {
//                if( i<input.length() )
//                    k=input.find_last_of( "BA" );
//                else
//                    j=input.find_last_of( "AB" );
                //cout<<i<<&#39; &#39;<<l<<endl;
                if( abs( i-l )==1 )
                    cout<<"NO";
                else
