head>
    ...
    <meta name="X-Csrf-Token" content="00284a27903e61aa815a4a7191379523"/>
    ...
    <meta property="og:title" content="Submission #13075682 - Codeforces"/>
    ...
    <title>Submission #13075682 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='00284a27903e61aa815a4a7191379523'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F579%2Fsubmission%2F13075682">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='00284a27903e61aa815a4a7191379523'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    <td>
        <a title="B - Finding Team Member" href="/contest/579/problem/B">579B</a>
...
int main()
{
    ...
    it--;
    it2--;
    for( ;it2!=map2.begin(); it--,it2-- )
    {
        if( map3[ it->second ]==0 && map3[ it2->second ]==0 )
        {
            map3[ it->second ]=it2->second;
            map3[ it2->second ]=it->second;
        }
    }
