head>
    ...
    <meta name="X-Csrf-Token" content="640f16eb1859976dcd799e9f2a9548fd"/>
    ...
    <meta property="og:title" content="Submission #12075132 - Codeforces"/>
    ...
    <title>Submission #12075132 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='640f16eb1859976dcd799e9f2a9548fd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F558%2Fsubmission%2F12075132">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='640f16eb1859976dcd799e9f2a9548fd'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    <td>
        <a title="B - Amr and The Large Array" href="/contest/558/problem/B">558B</a>
...
void f()
{
    int maxx,nega,posa,u[100001];
    map<int,int>neg,pos,f;
