head>
    ...
    <meta name="X-Csrf-Token" content="2fe0bde6134f8ffadcfaa5ce4359dcbd"/>
    ...
    <meta property="og:title" content="Submission #11974111 - Codeforces"/>
    ...
    <title>Submission #11974111 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2fe0bde6134f8ffadcfaa5ce4359dcbd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F443%2Fsubmission%2F11974111">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2fe0bde6134f8ffadcfaa5ce4359dcbd'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    ...
    <td>2015-07-08 18:18:41</td>
    <td>2015-07-08 18:18:42</td>
    <td>
...
void f()
{
    ...
    while( getline(cin,input) )
    {
        ...
        for( i=0;i<k;i++ )
        {
            if( isalpha( input[i] ) && !map1[ input[i] ] )
            {
                map1[ input[i] ]=1;
                ++c;
            }
