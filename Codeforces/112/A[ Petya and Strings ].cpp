head>
    ...
    <meta name="X-Csrf-Token" content="57dda02aca54dfbf6ebde5497b162560"/>
    ...
    <meta property="og:title" content="Submission #11598874 - Codeforces"/>
    ...
    <title>Submission #11598874 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='57dda02aca54dfbf6ebde5497b162560'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F112%2Fsubmission%2F11598874">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='57dda02aca54dfbf6ebde5497b162560'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    ...
    <td>2015-06-15 22:56:01</td>
    <td>2015-06-15 22:56:02</td>
    <td>
...
int main()
{
    ...
    while( cin>>input1 )
    {
        ...
        for( i=0; i<n ; i++ )
        {
            if( input1[i]+32==input2[i] || input1[i]-32==input2[i] || input1[i]==input2[i] )
            {
                continue;
            }
            else
