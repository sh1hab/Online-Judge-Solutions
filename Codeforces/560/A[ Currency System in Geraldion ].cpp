head>
    ...
    <meta name="X-Csrf-Token" content="21ad10bf06c6230872925998dcc817ba"/>
    ...
    <meta property="og:title" content="Submission #13186853 - Codeforces"/>
    ...
    <title>Submission #13186853 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='21ad10bf06c6230872925998dcc817ba'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F560%2Fsubmission%2F13186853">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='21ad10bf06c6230872925998dcc817ba'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    ...
    <td>2015-09-23 16:21:55</td>
    <td>2015-09-23 16:22:08</td>
    <td>
...
#define black 2
#define gray 3
int adj[100][100]= {0,},ver,edg,color[100],dis[100],parent[100],sor;
queue<int>q;
void bfs(int a)
{
    int i,j,u;
