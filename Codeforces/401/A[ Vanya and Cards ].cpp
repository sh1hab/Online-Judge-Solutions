head>
    ...
    <meta name="X-Csrf-Token" content="f2b08d7808c6a84d59249fd4c2c9c628"/>
    ...
    <meta property="og:title" content="Submission #12889221 - Codeforces"/>
    ...
    <meta name="cc" content="e14aaecde32c6442bf4c0d9369954d187e4ffb2f"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12889221 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f2b08d7808c6a84d59249fd4c2c9c628'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F401%2Fsubmission%2F12889221">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f2b08d7808c6a84d59249fd4c2c9c628'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/401">Problems</a></li>
        <li><a
                                        href="/contest/401/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/401/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/401/status">Status</a></li>
        <li><a
                                        href="/contest/401/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/401/room/1">Room</a></li>
        <li><a
                                        href="/contest/401/standings">Standings</a></li>
        <li><a
                                        href="/contest/401/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    <td>
        <a title="A - Vanya and Cards" href="/contest/401/problem/A">401A</a>
...
//                ++pos[ ( x ) ];
        ...
        for( i=b; i>=1 ; i-- )
        {
            ...
            if( m==0 )
                break;
            //m+=abs( pos[ it->first  ] - neg[ it->first  ] );
            //it++;
            //t++;
        }
        //b=b;
        //cout<<b<<&#39; &#39;<<a;
        //cout<<y[1]<<&#39; &#39;<<y[2]<<&#39; &#39;<<y[3]<<endl;,y
        //sort( y+1,y+x+1 );
