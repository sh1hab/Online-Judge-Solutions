head>
    ...
    <meta name="X-Csrf-Token" content="f50105ef2931dc123904158851242bbb"/>
    ...
    <meta property="og:title" content="Submission #11879061 - Codeforces"/>
    ...
    <title>Submission #11879061 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f50105ef2931dc123904158851242bbb'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F474%2Fsubmission%2F11879061">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f50105ef2931dc123904158851242bbb'/>
...
void input()
{
    char ch;
    string inpu;
    char keybord[]= {"qwertyuiopasdfghjkl;zxcvbnm,./"};
    cin>>ch;
    cin>>inpu;
    if( ch==&#39;R&#39; )
        a1=-1;
