head>
    ...
    <meta name="X-Csrf-Token" content="05d5906535426ccfa1f2b4aa1cf26adf"/>
    ...
    <meta property="og:title" content="Submission #12342728 - Codeforces"/>
    ...
    <meta name="cc" content="2a8ac583ff4363cb2383958a9f120c22c136cd5b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12342728 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='05d5906535426ccfa1f2b4aa1cf26adf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F268%2Fsubmission%2F12342728">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='05d5906535426ccfa1f2b4aa1cf26adf'/>
        ...
        for( it=map1.begin() ; it!=map1.end(); it++  )
        {
            if( map2[ it->first ]  )
            {
                //cout<<it->second<<&#39; &#39;<<it->first<<endl;
                 //if( it->second ==  )
                    j+=( it->second *map2[ it->first ]  );
                 //else
                    //j+=max( it->second, map2[ it->first ] );
            }
