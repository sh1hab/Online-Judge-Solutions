head>
    ...
    <meta name="X-Csrf-Token" content="43dacbbb057622eab3dd056bd59cd622"/>
    ...
    <meta property="og:title" content="Submission #13732538 - Codeforces"/>
    ...
    <meta name="cc" content="25b99dbe3af90a6825ddc54b9945d785fccdc016"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #13732538 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='43dacbbb057622eab3dd056bd59cd622'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F538%2Fsubmission%2F13732538">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='43dacbbb057622eab3dd056bd59cd622'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    <td>
        <a title="A - Cutting Banner" href="/contest/538/problem/A">538A</a>
    ...
    <td>2015-10-19 21:49:46</td>
    <td>2015-10-19 21:49:47</td>
    <td>
...
int main()
{
    ...
    while( cin>>s )
    {
        ...
        else
        {
            ...
            while (r < 10 && s[N - r - 1] == t[10 - r - 1])
            {
                //cout<<N-r-1<<&#39; &#39;<<10-r-1<<endl;
                //cout<<&#39;-&#39;<<s[ N-r-1 ]<<&#39;\n&#39;;
                ++r;
            }
