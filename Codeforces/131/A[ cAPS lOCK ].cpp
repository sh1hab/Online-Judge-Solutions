head>
    ...
    <meta name="X-Csrf-Token" content="a70b28bfccfe40c09ac2edbf329db524"/>
    ...
    <meta property="og:title" content="Submission #11514156 - Codeforces"/>
    ...
    <title>Submission #11514156 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a70b28bfccfe40c09ac2edbf329db524'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F131%2Fsubmission%2F11514156">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a70b28bfccfe40c09ac2edbf329db524'/>
...
int main()
{
    long long n, c, d, sum, i, j, l, k, m,upper,lower;
    ...
    while( cin>>input )
    {
        ...
        if( upper==input.length() || ( islower( input[0] ) && upper==input.length()-1 ) )
            cout<<output;
        else
            cout<<input;
        cout<<endl;
