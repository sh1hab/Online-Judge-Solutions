head>
    ...
    <meta name="X-Csrf-Token" content="62294400ae1e519f1bab06a564432d52"/>
    ...
    <meta property="og:title" content="Submission #12314490 - Codeforces"/>
    ...
    <meta name="cc" content="629d9b5634049dcc0b4679613562d4ffad3df3ef"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12314490 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='62294400ae1e519f1bab06a564432d52'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F471%2Fsubmission%2F12314490">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='62294400ae1e519f1bab06a564432d52'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/471">Problems</a></li>
        <li><a
                                        href="/contest/471/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/471/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/471/status">Status</a></li>
        <li><a
                                        href="/contest/471/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/471/room/1">Room</a></li>
        <li><a
                                        href="/contest/471/standings">Standings</a></li>
        <li><a
                                        href="/contest/471/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    <td>
        <a title="A - MUH and Sticks" href="/contest/471/problem/A">471A</a>
    ...
    int main() 
    {
        int n,fours,twos,fives,c,h;
        //cin>>n;
        int input[24]={0};
        string out;
        //c=1;
        //fours=twos=fives=0;
        //memset( in=put,-1,sizeof( input ) );
        for( int i=0;i<6;i++ )
        {
            cin>>h;
            ++input[h];
