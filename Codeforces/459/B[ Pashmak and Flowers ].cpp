head>
    ...
    <meta name="X-Csrf-Token" content="b92d996e54c8b7442a2239e0fe43db8a"/>
    ...
    <meta property="og:title" content="Submission #12832943 - Codeforces"/>
    ...
    <title>Submission #12832943 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b92d996e54c8b7442a2239e0fe43db8a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F459%2Fsubmission%2F12832943">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b92d996e54c8b7442a2239e0fe43db8a'/>
...
<a href="/profile/chachachowdhury" title="Newbie chachachowdhury" class="rated-user user-gray">chachachowdhury</a>    </td>
    ...
    <td>2015-09-03 21:39:56</td>
    <td>2015-09-03 21:40:18</td>
    <td>
...
void f()
{
    long long x,y[200001];
    map<long long ,long long>map1;
    map<long long ,long long>:: iterator it,t;
    cin>>x;
...
//cout<<y[1]<<&#39; &#39;<<y[2]<<&#39; &#39;<<y[3]<<endl;,y
    ...
    else
    {
        ...
        m=0;
        k=0;
        for( it=map1.begin(); it->first < t->first ; ++it )
        {
            if( ( t->first-it->first )== j )
            {
                m=it->second;
                n=t->second;
                --t;
